  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#061625] via-[#0b1f33] to-[#061625] text-white">
      ...
      <div className="absolute inset-0 pointer-events-none">
        {/* Right blue blob */}
        <div className="absolute top-0 right-0 w-[55%] h-full bg-gradient-to-b from-[#1e6cff] to-[#0a3a7a] rounded-bl-[200px] opacity-90"></div>

        {/* Thin wave line */}
        <svg
          className="absolute right-[15%] top-0 h-full"
          width="2"
          height="100%"
          viewBox="0 0 2 1000"
